                        ...
                        <form action="insert_order.php" method="post">
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-12">
                                <div class="sm:col-span-6">
                                    <label for="products" class="block text-sm font-medium leading-6 text-pink-400 text-2xl">Customer</label>
                                    <div class="mt-2">
                                        <select id="customerid" name="customerid" class="product-select mt-1 block w-full text-pink-400" required>
                                ...
                                <div class="sm:col-span-6">
                                    <label for="discount_order" class="block text-sm font-medium leading-6 text-pink-400 text-2xl">Discount</label>
                                    <div class="mt-2">
                                        <input type="text" id="discount_order" name="discount_order" autocomplete="off" class="block w-full rounded-md border-0 pl-2 py-2.5 text-pink-400 shadow-sm ring-1 ring-inset ring-pink-400 placeholder:text-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-400 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-5">
                                        <div class="sm:col-span-1">
                                            <label for="products" class="block text-sm font-medium leading-6 text-pink-400">Product
                                                Name</label>
                                            <div class="mt-2">
                                                <select id="productId0" name="productId[]" class="product-select mt-1 block w-full text-pink-400" required>
                                                    <option value="">Select Product</option>
                                                    <?php foreach ($products as $product) : ?>
                                        ...
                                        <div class="sm:col-span-1">
                                            <label for="region" class="block text-sm font-medium leading-6 text-pink-400">Unit
                                                Price</label>
                                            <div class="mt-2">
                                                <input type="text" id="unitprice0" name="unitprice[]" autocomplete="off" class="block w-full rounded-md border-0 pl-2 py-2.5 text-pink-400 shadow-sm ring-1 ring-inset ring-pink-400 placeholder:text-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-400 sm:text-sm sm:leading-6">
                                            </div>
                                        </div>
                                        <div class="sm:col-span-1">
                                            <label for="region" class="block text-sm font-medium leading-6 text-pink-400">Quantity</label>
                                            <div class="mt-2">
                                                <input type="text" id="quantity0" name="quantity[]" autocomplete="off" class="block w-full rounded-md border-0 pl-2 py-2.5 text-pink-400 shadow-sm ring-1 ring-inset ring-pink-400 placeholder:text-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-400 sm:text-sm sm:leading-6">
                                            </div>
                                        </div>
                                        <div class="sm:col-span-1">
                                            <label for="region" class="block text-sm font-medium leading-6 text-pink-400">Discount</label>
                                            <div class="mt-2">
                                                <input type="text" id="discount0" name="discount[]" autocomplete="off" class="block w-full rounded-md border-0 pl-2 py-2.5 text-pink-400 shadow-sm ring-1 ring-inset ring-pink-400 placeholder:text-pink-400 focus:outline-none focus:ring-2 focus:ring-pink-400 sm:text-sm sm:leading-6">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <button type="button" onclick="addProduct()" class="border border-pink-500 bg-pink-700 text-white font-bold py-2 px-4 rounded cursor-pointer">Add
                                Another Product</button><br><br>
                            <!-- Employee Information -->

                            <!-- Submit Button -->
                            <input type="submit" class="border border-pink-500 bg-pink-700 text-white font-bold py-2 px-4 rounded cursor-pointer" value="Submit Order">
                        </form>
                    </div>
                </div>
